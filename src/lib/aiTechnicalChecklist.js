  ...
  (zones || []).forEach((zone, index) => {
    ...
    if (hasSystem(surveySystems, "aps") || hasSystem(surveySystems, "soue") || hasSystem(surveySystems, "sots")) {
      ...
      photoPrompts.push({
        ...
        hint:
          "Можно загрузить сразу несколько планов по этажам. Снимайте каждый план с расстояния примерно 0.7-1.5 м, держите камеру почти параллельно плоскости плана без сильного наклона, захватывайте лист целиком, без бликов и смаза. Фото с пригодностью ниже 70% система отклонит.",
