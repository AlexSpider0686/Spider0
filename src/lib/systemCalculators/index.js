...
function buildInvalidResult(system, objectData, errors = [], warnings = []) {
  ...
  return {
    ...
    executionHours: 0,
    executionTeamSize: 0,
    executionRecommendedTeamSize: 0,
    executionDurationDays: 0,
    executionDurationMonths: 0,
    executionRoles: [],
    executionRecommendedRoles: [],
    designHours: 0,
    designBase: 0,
    designCharges: 0,
    designTotal: 0,
...
export function calculateSystemWithBreakdown(
  ...
  let laborModel = calculateLaborCost({
    ...
    executionRoleOverrides: system.executionRoleOverrides,
  ...
  const systemResult = {
    ...
    executionTeamSize: laborModel.executionTeamSize || laborModel.crewSize,
    executionRecommendedTeamSize: laborModel.executionRecommendedTeamSize || 0,
    executionDurationDays: laborModel.executionDays,
    executionDurationMonths: laborModel.executionMonths,
    executionDaysExact: laborModel.executionDaysExact || laborModel.executionDays,
    executionRoles: laborModel.executionRoles || [],
    executionRecommendedRoles: laborModel.executionRecommendedRoles || [],
    ...
    laborDetails: {
      ...
      routingWorkCost,
      executionDailyCapacity: laborModel.executionDailyCapacity,
      executionProductiveHoursPerPersonDay: laborModel.executionProductiveHoursPerPersonDay,
      executionStaffingCostFactor: laborModel.executionStaffingCostFactor,
      executionThroughputFactor: laborModel.executionThroughputFactor,
      executionWeightedCostIndex: laborModel.executionWeightedCostIndex,
