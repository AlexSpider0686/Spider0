  ...
  return (
    <main>
      <section className="hero">
        ...
        <div className="container hero__content">
          ...
          <p className="hero__lead">
            Платформа собирает бюджет по АПС, СОУЭ, СОТС, СОТ, СКУД и ССОИ, учитывает зонирование, тип объекта, регион,
            а затем запускает собственный AI-аудит цен и трудозатрат, который снимает риск недооцененности бюджета.
          </p>
      ...
      <section className="section section--dark" id="comparison">
        <div className="container">
          <SectionHeader eyebrow="Позиционирование" title="Почему SmetaCore нужен рынку прямо сейчас">
            ...
            для нескольких систем безопасности с AI-аудитом цен и защитой от недооценки до сих пор почти свободна.
          </SectionHeader>
        ...
        <div className="container feature-layout">
          <div>
            <SectionHeader eyebrow="Ключевая особенность" title="Собственный AI-аудит цен и трудозатрат уже встроен в расчет">
              Это не декоративный AI-блок и не внешняя экспертиза после расчета. Нейросетевой контур встроен прямо в
              расчетный движок, проверяет рынок и не дает бюджету “провалиться” в зону недооценки.
            </SectionHeader>
          ...
          <div className="spotlight-card">
            ...
            <p>
              SmetaCore не просто выдает сумму, а показывает, из чего она собрана: объемы, источники цен, единичные
              расценки, коэффициенты, рыночный floor и AI-проверку риска недооценки.
            </p>
            <button className="btn btn--primary" onClick={() => setAuthOpen(true)}>
      ...
      <section className="section section--dark ai-showcase" id="ai-engine">
        <div className="container">
          <SectionHeader eyebrow="AI-движок SmetaCore" title="Как именно AI снимает риск недооцененности бюджета">
            Алгоритм одновременно работает в контуре цен и в контуре работ. Он проверяет рыночные предложения, анализирует
            структуру проекта и усиливает расчет там, где видит признаки занижения.
          </SectionHeader>
      ...
      <section className="section section--light" id="calculation-logic">
        <div className="container">
          <SectionHeader
            ...
            title="Как формируется бюджет: от параметров объекта до итоговой суммы проекта"
          >
            Расчет идет по фиксированной последовательности: входные данные, автоматическое определение объемов, AI-аудит
            цен, проверка риска недооценки работ, применение коэффициентов и формирование финального бюджета.
          </SectionHeader>
          ...
          <div className="budget-formula">
            ...
            <p>
              ...
              Внутри блока работ уже учтены единичные расценки, коэффициенты условий, регион, рыночный floor и AI-проверка
              недооценки.
            </p>
          </div>
        </div>
        ...
        <div className="container legal-strip">
          <div>
            ...
            <p>
              ...
              персональных данных, cookies policy и отдельный отказ от ответственности по точности расчетов, так как
              платформа предназначена для предварительной бюджетной оценки.
            </p>
          </div>
