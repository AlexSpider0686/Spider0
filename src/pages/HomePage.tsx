...
const aiTechnicalSolutionPoints = [
  ...
  "Фотофиксация помогает автоматически подтвердить план эвакуации, материал стен, тип потолков и при достаточной уверенности оценить высоту помещения по фото.",
      ...
      <section className="section section--light" id="ai-technical-solution">
        <div className="container feature-layout">
          ...
          <div className="spotlight-card">
            ...
            <p>
              AI-модуль связывает параметры объекта, реестр систем, наличие РД, ответы обследования и фотофиксацию в один сценарий. Он не только читает признаки по снимкам, но и фильтрует нерелевантные фото, а при хорошем ракурсе может автоматически оценить высоту помещения. За счет этого предварительная спецификация становится ближе к фактическим условиям монтажа, а не только к усредненной модели по площади.
            </p>
            <p>
