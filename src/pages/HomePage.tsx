...
const aiTechnicalSolutionPoints = [
  "Новый модуль AI-планирования по кнопке «Сгенерировать план проекта» собирает детальный график реализации систем в PowerPoint или MS Project XML и синхронизирует его верхнеуровневые сроки с экспортируемым ТКП.",
  ...
  "Внутри AI-Технического решения работает модуль распознавания планировок: он анализирует план эвакуации, выделяет охранные зоны для СОТС, зоны оповещения для СОУЭ и ЗКСПС для АПС, а затем перепроверяет результат по данным объекта.",
      ...
      <section className="section section--light" id="ai-technical-solution">
        <div className="container feature-layout">
          ...
          <div className="spotlight-card">
            ...
            <p>
              На том же контуре теперь работает и AI-планирование: после расчета платформа может выпустить детальный план проекта с мероприятиями, сроками и оговоркой по допущениям в формате PowerPoint или MS Project XML.
            </p>
          </div>
        </div>
      </section>
