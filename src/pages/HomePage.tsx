...
const commonLogicBlocks = [
  ...
  },
  {
    ...
    points: [
      ...
      "Базовые ставки берутся из внутренних нормативных справочников платформы (по типам систем, работ, КНС и проектированию).",
      ...
      "Также применяется региональный коэффициент и коэффициент эксплуатируемого здания.",
    ],
  },
];
...
const systemLogic = [
  {
    ...
    autoCalc:
      "Количество извещателей по зонам, адресные линии/шлейфы, приборы, шкафы, длины кабелей, объем СМР и ПНР. При наличии проекта в требуемом PDF-формате система автоматически распознает спецификацию и использует уточненные объемы оборудования и материалов.",
    result:
      ...
      <section className="section section--light" id="calculation-logic">
        <div className="container">
          ...
          <div className="budget-formula">
            ...
            <p>
              Итог = [Оборудование + Материалы + (Работы × Коэффициенты условий × Коэффициент статуса здания ×
              Региональный коэффициент)] + Проектирование + Рентабельность + НДС. Все коэффициенты применяются только к
              стоимости работ.
            </p>
          </div>
        </div>
