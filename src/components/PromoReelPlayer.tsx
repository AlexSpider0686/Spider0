...
const PROMO_SCENES: PromoScene[] = [
  ...
  },
  {
    id: "risk",
    title: "Risk Guard AI",
    subtitle: "Контроль сбалансированности, коэффициентов и точности трудовой части",
    voice: "Отдельный контур перепроверяет бюджет на недооцененность и переоцененность и подсказывает, где нужна балансировка.",
    duration: 4.8,
