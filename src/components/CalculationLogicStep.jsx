    ...
    <section className="panel">
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>
            Нейросетевой модуль подключается при работе с PDF-проектом: распознает строки спецификации, сверяет единицы измерения, выявляет конфликтные позиции и передает в расчет валидированный перечень.
          </p>
