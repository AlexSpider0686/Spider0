...
function formatSourceHost(url) {
  ...
  if (!value) return "РЅРµС‚ СЃСЃС‹Р»РєРё";
  try {
    ...
    <section className="panel">
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>Р‘Р°Р·РѕРІС‹Рµ РѕСЂРёРµРЅС‚РёСЂС‹ Р±РµСЂСѓС‚СЃСЏ РёР· РІРЅСѓС‚СЂРµРЅРЅРёС… СЃРїСЂР°РІРѕС‡РЅРёРєРѕРІ, РїРѕСЃР»Рµ С‡РµРіРѕ Р·Р°РїСѓСЃРєР°РµС‚СЃСЏ AI-Р°СѓРґРёС‚ С†РµРЅ: СЃРёСЃС‚РµРјР° РёС‰РµС‚ СЃРѕРїРѕСЃС‚Р°РІРёРјС‹Рµ РїСЂРµРґР»РѕР¶РµРЅРёСЏ Сѓ РїРѕСЃС‚Р°РІС‰РёРєРѕРІ Рё РЅР° СЃР°Р№С‚Рµ РїСЂРѕРёР·РІРѕРґРёС‚РµР»СЏ РІС‹Р±СЂР°РЅРЅРѕРіРѕ РІРµРЅРґРѕСЂР°.</p>
          <p>РџРѕ РєР°Р¶РґРѕР№ РїРѕР·РёС†РёРё С„РёРєСЃРёСЂСѓСЋС‚СЃСЏ РЅР°Р№РґРµРЅРЅС‹Рµ РёСЃС‚РѕС‡РЅРёРєРё, СЃС‚СЂР°С‚РµРіРёСЏ РІС‹Р±РѕСЂР°, СѓСЂРѕРІРµРЅСЊ СѓРІРµСЂРµРЅРЅРѕСЃС‚Рё Рё РЅРµРѕР±С…РѕРґРёРјРѕСЃС‚СЊ СЂСѓС‡РЅРѕР№ РїРµСЂРµРїСЂРѕРІРµСЂРєРё. Р­С‚Рѕ СЃРЅРёР¶Р°РµС‚ СЂРёСЃРє РѕРїРѕСЂС‹ РЅР° РµРґРёРЅРёС‡РЅСѓСЋ РёР»Рё СЃР»СѓС‡Р°Р№РЅРѕ Р·Р°РЅРёР¶РµРЅРЅСѓСЋ С†РµРЅСѓ.</p>
        </article>
            ...
            {vendorPricingPositionRows.map((row) =>
              row.positions.map((item, index) => (
                <p key={`pricing-position-${row.systemId}-${index}`}>
                  ...
                  {rub(item.unitPrice)}, СЃСѓРјРјР° РїРѕ РїСЂРѕРµРєС‚Сѓ {rub(item.total)}. РСЃС‚РѕС‡РЅРёРє: {item.sourceLabel}.
