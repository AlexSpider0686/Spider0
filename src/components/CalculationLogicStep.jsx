    ...
    <section className="panel">
      <div className="panel-header">
        <div>
          ...
          <p>Пошагово: как система собирает цены, проводит AI-аудит, проверяет риск недооценки и формирует итоговый бюджет.</p>
        </div>
      </div>
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>
            Базовые стоимостные показатели берутся из внутренних справочников, затем система запускает автоматизированный AI-аудит цен: опрашивает рынок,
            сверяет найденные предложения, оценивает качество совпадений и защищает расчет от заниженной цены.
          </p>
          <p>
            Источники цен: сайт производителя выбранного вендора + Tinko + Luis + Garant + Ganimed. По каждому источнику фиксируются факт опроса,
            успешность получения цены, стратегия выбора и уровень уверенности AI-аудита.
          </p>
        </article>
        ...
        <article className="logic-card">
          ...
          <p>
            Ставки берутся из встроенных справочников расчетного ядра и откалиброваны в консервативном диапазоне по рынку РФ. Для защиты бюджета система
            использует рыночный пол СМР+ПНР и не допускает падения ниже безопасного диапазона.
          </p>
          <p>
        ...
        <article className="logic-card">
          ...
          <p>
            ...
            эксплуатируемом здании и региональный коэффициент, при этом регион не может искусственно удешевить труд ниже базового уровня.
          </p>
          <p>
        ...
        <article className="logic-card">
          ...
          <p>
            ...
            пересчет объемов, повторный опрос цен, AI-аудит, проверка риска недооценки работ и обновление общего бюджета.
          </p>
          <p>
            Нейросетевой модуль подключается в двух контурах: распознает и валидирует PDF-спецификацию, а также оценивает риск занижения СМР+ПНР по
            плотности элементов, кабельной насыщенности, КНС, региону и составу проекта.
          </p>
