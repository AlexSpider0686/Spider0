    ...
    <section className="panel">
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>Источник базовых расценок — внутренняя нормативная база платформы: в ней зафиксированы единичные ставки на монтаж, ПНР, интеграцию, кабельные и КНС-работы по каждому типу системы, а также консервативные нижние пороги, ниже которых трудовая часть не может быть опущена даже при неполных или слишком оптимистичных исходных данных. Это утвержденная расчетная база текущей версии платформы, а не произвольные цифры из конкретной сметы.</p>
          <p>
