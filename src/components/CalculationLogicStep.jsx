    ...
    <section className="panel">
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>
            Итог складывается из блоков: оборудование + материалы + работы + проектирование. После прямых затрат добавляется прибыль и НДС (если выбран
            режим ОСНО).
          </p>
          <p>
            Формула: <strong>Итог = (Оборудование + Материалы + Работы + Проектирование + Прибыль) + НДС</strong>.
          </p>
          <p>
