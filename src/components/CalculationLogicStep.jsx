    ...
    <section className="panel">
      ...
      <div className="logic-grid">
        ...
        <article className="logic-card">
          ...
          <p>
            После заполнения объекта система может запустить AI-обследование. Сначала пользователь фиксирует состав систем и наличие РД, затем платформа строит
            адаптивный чек-лист по объекту, зонам и системам без рабочей документации.
          </p>
          <p>
            Вопросы чек-листа зависят от статуса объекта, площади, этажности и типа зон. Фотофиксация помогает автоматически подтвердить часть инженерных условий,
            определить материал стен и тип потолка, а при хорошем снимке еще и оценить высоту помещения. Если уверенности недостаточно, высота остается обязательной
            для ручного ввода.
          </p>
          <p>
            В модуль встроена защита от ложной фотоинформации: план, схема или нерелевантное фото не попадают в чек-лист и не искажают обследование. На выходе
            модуль передает в AI-конфигуратор только валидированные данные и уточняет состав оборудования и материалов до формирования итоговой спецификации.
          </p>
        </article>
        ...
        <article className="logic-card">
          <h3>6. AI-проверка недооценки</h3>
          <p>
        ...
        <article className="logic-card">
          <h3>7. Коэффициенты и начисления</h3>
          <p>
        ...
        <article className="logic-card">
          <h3>9. Итоговая формула бюджета</h3>
          <p>
        ...
        <article className="logic-card">
          <h3>10. Что происходит при изменении параметров</h3>
          <p>
