    ...
    <section className="panel">
      ...
      <div className="subpanel">
        ...
        <div className="preset-row">
          ...
          <button className="ghost-btn" type="button" onClick={() => applyZonePreset(zonePreset)}>Применить пресет</button>
          <button className="ghost-btn" type="button" onClick={() => setZones((prev) => normalizeZoneAreas(prev, objectData.totalArea))}>Нормализовать</button>
        </div>
