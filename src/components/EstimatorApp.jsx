      ...
      <div className={`app-wrap ${authorized ? "" : "locked"}`} aria-hidden={!authorized}>
        {demoMode ? (
          <section className="demo-banner">
            <div>
              <strong>Демо-версия Project.Core™</strong>
              <p>
                Открыт готовый пример объекта, зонирование, системы, бюджет и логика расчета. Экспорт, AI-обследование, PDF-импорт и
                онлайн-обновление цен в демо отключены.
              </p>
            </div>
        ...
        <header className="hero-card">
          ...
          <button className="primary-btn" onClick={vm.exportEstimate} type="button" disabled={demoMode}>
        ...
        {vm.step === 0 ? <ObjectStep {...vm} demoMode={demoMode} /> : null}
        {vm.step === 1 ? <SystemsStep {...vm} demoMode={demoMode} /> : null}
