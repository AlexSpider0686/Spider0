    ...
    <section className="panel">
      <div className="panel-header">
        <div>
          ...
          <p>
            Вкладка управляет составом монтажной бригады по каждой системе. Рекомендованный состав рассчитывается по трудоемкости,
          ...
          return (
            <article className="logic-card" key={`resource-staffing-${system.id}`}>
              ...
              <div className="input-card" style={{ marginTop: 12 }}>
                ...
                <small className="hint-inline">
                  Добавление прорабов, старших монтажников и инженеров ПНР повышает координационную стоимость, но может ускорить прохождение
                  критических фаз. Недобор ключевых ролей снижает суточную производительность и увеличивает календарный срок.
                </small>
                <small className="hint-inline">
