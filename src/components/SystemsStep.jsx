              ...
              {system.type === "aps" ? (
                <div className="calc-explain aps-import-card">
                  ...
                  <p className="hint-inline">
                    ...
                    перепроверяет риск цен и баланс работ, чтобы выявлять недооцененность или перезаложенность. Если проект не загружен, используется внутренняя расчетная модель.
                  </p>
