...
export const LABOR_UNIT_RATES = {
  aps: {
    mountPrimary: 960,
    pnrPrimary: 240,
    controllerMount: 5200,
    pnrActiveElement: 760,
    cablePerMeter: 68,
    knsPerMeter: 108,
  ...
  sots: {
    mountPrimary: 900,
    pnrPrimary: 220,
    controllerMount: 4300,
    pnrActiveElement: 640,
    cablePerMeter: 64,
    knsPerMeter: 104,
  ...
  sot: {
    mountPrimary: 2550,
    pnrPrimary: 620,
    controllerMount: 7600,
    pnrActiveElement: 1180,
    cablePerMeter: 78,
    knsPerMeter: 112,
  ...
  ssoi: {
    mountPrimary: 3500,
    pnrPrimary: 1480,
    controllerMount: 11200,
    pnrActiveElement: 1680,
    cablePerMeter: 58,
    knsPerMeter: 108,
    integrationPoint: 6500,
    designHour: 2650,
  },
  skud: {
    mountPrimary: 2900,
    pnrPrimary: 680,
    controllerMount: 8400,
    pnrActiveElement: 1140,
    cablePerMeter: 76,
    knsPerMeter: 108,
    integrationPoint: 3400,
    designHour: 2450,
  },
};
...
export const LABOR_MARKET_GUARDRAILS = {
  aps: {
    minBaseFactor: 1.08,
    minFinalPerMarker: 11250,
    riskBias: 0.2,
    maxRiskUplift: 0.16,
  },
  soue: {
    minBaseFactor: 1.07,
    minFinalPerMarker: 6900,
    riskBias: 0.18,
    maxRiskUplift: 0.14,
  },
  sots: {
    minBaseFactor: 1.08,
    minFinalPerMarker: 5200,
    riskBias: 0.18,
    maxRiskUplift: 0.14,
  },
  sot: {
    minBaseFactor: 1.09,
    minFinalPerMarker: 8200,
    riskBias: 0.17,
    maxRiskUplift: 0.15,
  },
  ssoi: {
    minBaseFactor: 1.1,
    minFinalPerMarker: 18200,
    riskBias: 0.16,
    maxRiskUplift: 0.14,
  },
  skud: {
    minBaseFactor: 1.09,
    minFinalPerMarker: 9800,
    riskBias: 0.18,
    maxRiskUplift: 0.15,
  },
};
