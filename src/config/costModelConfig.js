...
export const LABOR_UNIT_RATES = {
  ...
  soue: {
    mountPrimary: 1260,
    pnrPrimary: 340,
    controllerMount: 6900,
    pnrActiveElement: 1020,
    cablePerMeter: 122,
    knsPerMeter: 176,
    integrationPoint: 3900,
    designHour: 2500,
  },
  sots: {
    mountPrimary: 1080,
    pnrPrimary: 300,
    controllerMount: 5400,
  ...
  sot: {
    ...
    pnrActiveElement: 1420,
    cablePerMeter: 128,
    knsPerMeter: 182,
    integrationPoint: 4300,
    designHour: 2650,
  },
  ssoi: {
    mountPrimary: 4180,
    pnrPrimary: 1720,
    controllerMount: 12900,
    pnrActiveElement: 1960,
    cablePerMeter: 116,
    knsPerMeter: 176,
    integrationPoint: 7800,
    designHour: 2800,
  },
  skud: {
    mountPrimary: 3440,
    pnrPrimary: 840,
    controllerMount: 10100,
    pnrActiveElement: 1380,
    cablePerMeter: 124,
    knsPerMeter: 178,
    integrationPoint: 4500,
    designHour: 2600,
  },
};
