...
export const ZONE_PRESET_DETAILS = {
  business_center: {
    summary:
      "Офисы доминируют: расчет обычно ровный, со средней плотностью устройств и умеренными затратами на кабель и монтаж.",
  },
  office_building: {
    summary:
      "Больше типовых офисных помещений: смета становится более предсказуемой, с меньшей долей сложных общественных зон.",
  },
  residential_complex: {
    summary:
      "Больше МОП, входных групп и паркинга: обычно растут длина трасс, число точек и стоимость монтажных работ.",
  },
  warehouse: {
    summary:
      "Низкая плотность оборудования на м2, но большие площади часто сохраняют заметный объем кабельных трасс.",
  },
  parking: {
    summary:
      "Меньше устройств на м2, но из-за периметра и длинных маршрутов может вырасти кабельная часть и узлы подключения.",
  },
  mixed_use: {
    summary:
      "Самый чувствительный пресет: смешение функций повышает разброс по плотности систем, монтажу и итоговой смете.",
  },
};
