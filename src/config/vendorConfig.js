...
export const VENDOR_EQUIPMENT = repairCatalogNode({
  ...
  sots: {
    Базовый: {
      ...
      panel: {
        loops: [2, 4, 8],
        basePrices: { 2: 3650, 4: 4277, 8: 8950 },
      },
